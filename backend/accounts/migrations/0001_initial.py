    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone_verification_code', models.CharField(blank=True, max_length=6, null=True, verbose_name='Код подтверждения телефона')),
                ...
                ('otp_secret', models.CharField(blank=True, max_length=32, null=True, verbose_name='Секрет для OTP')),
